var rule = {
    ...
    url:'/list/fyclass.htm?page=fly page',
    searchable:2,
    quickSearch:0,
    headers:{
    ...
    lazy:"js:input=input.replace(/play\\/(\\w+)\\.htm/,'ajax/?act=songinfo&id=$1&lang=').replace('www.','');log(input);let mp3=JSON.parse(request(input)).data.mp3;input={jx:0,url:'https://zz123.com'+mp3,parse:1,header:JSON.string ify({Referer:'https://www.zz123.com/'})}",
    limit:6,
