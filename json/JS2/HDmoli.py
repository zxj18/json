...
class Spider(Spider):
	...
	def homeContent(self,filter):
		result = {}
		url = 'https://www.hdmoli.com/search.php?searchtype=5&tid=6'
	...
	def homeVideoContent(self):
		url = 'https://www.hdmoli.com/api.php/provide/homeBlock?type_id=0'
		rsp = self.fetch(url,headers=self.header)
		jo = json.loads(rsp.text)
	...
	def categoryContent(self,tid,pg,filter,extend):
		...
		suffix = ''.join(params)
		url = 'https://www.hdmoli.com/api.php/provide/searchVideo?searchName=**'.format(suffix)
		rsp = self.fetch(url,headers=self.header)
		jo = json.loads(rsp.text)
	...
	def detailContent(self,array):
		tid = array[0]
		url = 'https://www.hdmoli.com/api.php/provide/videoDetail?devid=453CA5D864457C7DB4D0EAA93DE96E66&package=com.sevenVideo.app.android&version=1.8.7&ids={0}'.format(tid)
		rsp = self.fetch(url,headers=self.header)
		jo = json.loads(rsp.text)
		node = jo['data']
		vod = {
		...
		listUrl = 'https://www.hdmoli.com/api.php/provide/videoPlaylist?devid=453CA5D864457C7DB4D0EAA93DE96E66&package=com.sevenVideo.app.android&version=1.8.7&ids={0}'.format(tid)
	...
	def searchContent(self,key,quick):		
		url = 'https://www.hdmoli.com/api.php/provide/searchVideo?searchName=**'.format(key)
		rsp = self.fetch(url,headers=self.header)
		jo = json.loads(rsp.text)
		vodList = jo['data']
		videos = []
	...
	def playerContent(self,flag,id,vipFlags):
		result = {}
		url = 'https://www.hdmoli.com/api.php/provide/parserUrl?url={0}'.format(id)
